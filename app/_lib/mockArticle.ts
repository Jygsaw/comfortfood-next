export const MOCK_ARTICLE = {
    ...
    createdAt: "April 08, 2022",
    updatedAt: "April 08, 2022",
    content: `
        <image src="https://www.simplyrecipes.com/thmb/aNnI7QfPFNrPdzU0Mbb7EcRvN4I=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/Simply-Recipes-Expiration-Dates-LEAD-a9c08d6e07f14ea1a80e06e1dd86cdd7.jpg" alt="" />
        <nav>
        <h2>
        IN THIS ARTICLE
        </h2>
        ...
        <img src="https://www.simplyrecipes.com/thmb/cQ6cV2mVF9r6lwSVt2g9W9SK-wE=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/Simply-Recipes-HT-Store-Spices-LEAD-2-d9820881e0c948e488192fe13fe04b5b.jpg" alt="" />
        ...
        <img src="https://www.simplyrecipes.com/thmb/HqKMGxc0PuEkscWb9jGA696qmc8=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/__opt__aboutcom__coeus__resources__content_migration__simply_recipes__uploads__2019__10__Peanut-Butter-Roundup-LEAD-03-b72485b163b748f2962d437f8e9ed44d.jpg" alt="" />
