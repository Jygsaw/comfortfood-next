    ...
    content: `
        ...
        <div class="article-container">
            <nav class="article-nav">
                ...
                <ul>
                    <li>
                        <a href="#why-dates" class="article-link">
                        Why do we have expiration dates, sell-by dates, use-by dates, and best-by dates?
                        </a>
                    </li>
                    <li>
                        <a href="#exp-dates" class="article-link">
                        What are expiration dates?
                        </a>
                    </li>
                    <li>
                        <a href="#best-by" class="article-link">
                        What are best-by and use-by dates?
                        </a>
                    </li>
                    <li>
                        <a href="#sell-by" class="article-link">
                        What are sell-by dates?
                        </a>
                    </li>
                    <li>
                        <a href="#other-dates" class="article-link">
                        What about the other dates that may be printed on the food label?
                        </a>
                    </li>
                    <li>
                        <a href="#food-safety" class="article-link">
            ...
            <h2 id="why-dates" class="article-h2">
            Why do we have expiration dates, sell-by dates, use-by dates, and best-by dates?
            </h2>
            ...
            <h2 id="exp-dates" class="article-h2">
            What are expiration dates?
            </h2>
            ...
            <img class="article-img" src="https://www.simplyrecipes.com/thmb/cQ6cV2mVF9r6lwSVt2g9W9SK-wE=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/Simply-Recipes-HT-Store-Spices-LEAD-2-d9820881e0c948e488192fe13fe04b5b.jpg" alt="" />

            <h2 id="best-by" class="article-h2">
            What are best-by and use-by dates?
            </h2>
            ...
            <h2 id="sell-by" class="article-h2">
            What are sell-by dates?
            </h2>
            ...
            <img class="article-img" src="https://www.simplyrecipes.com/thmb/HqKMGxc0PuEkscWb9jGA696qmc8=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/__opt__aboutcom__coeus__resources__content_migration__simply_recipes__uploads__2019__10__Peanut-Butter-Roundup-LEAD-03-b72485b163b748f2962d437f8e9ed44d.jpg" alt="" />

            <h2 id="other-dates" class="article-h2">
            What about the other dates that may be printed on the food label?
            </h2>
            ...
            <h2 id="food-safety" class="article-h2">
            Is expired food safe to eat? Can I get sick from eating expired food?
            </h2>
